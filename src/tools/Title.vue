...
<template>
    <div class="bg">
        <div class="output_box">
            <div class="letter" v-if="is_vedio == 1">
                ...
                <p style="text-indent: 60px;">我知道这样突然的地方式很冒昧，也很唐突，但请你理解我的做法。这可以是一个大胆且勇敢的做法，也可以是一个有趣的互动。容我在此先介绍一下我自己，我是
                    来自21级计算机学院的一位同学，你暂且可以叫我小王。短暂说明一下我的来意，我第一次在食堂见过你，觉得很是欣赏，但是后来却没有什么机会见到了。上个月我在刷抖音的时候，碰巧刷到了你，
                    所以果断关注了。我看了你的所有作品感觉很不错，真的很喜欢。经过后续对你的关注产生了想法，就是写一个网站，这个网站是我专门为你写的(在公司顶着被抓的时候写的)，我想通过这个网站能
                    不能交到一位好朋友。我是带着很欣赏的态度来的，当然这完全凭你的个人意愿，如果不可以的话你也可以拒绝我。你可以在右上角的选择栏点击拒绝就好了。不过在此之前我需要再争取一下，看完
                    信后请你点击信封下面的视频，如果还是不行的话，就继续点击拒绝按钮。如果我可以的话，请你点击接受按钮。我希望你我都多一个朋友，所谓“只要朋友多，天下也好说”。我是带着我所有的真诚
                    来的，从我精心做的这个网站应该就可以看出吧，我希望你可以同意。另外我现有的服务器带宽有点拉，播放视频的时候估计要等一会，请耐心等待一下可以么。
                </p>
                <p style="text-indent: 60px;">你的抖音昵称为什么叫不吃糖啊?不吃糖的话，巧克力行么?</p>
                <p style="text-indent: 1200px;">------小王</p>
            </div>
        ...
        <div class="getmsg_box">
            <button class="letter_but" @click="letter_click">
                <img class="im" src="../images/letter.png">
            </button>
            <button class="vedio_but" @click="vedio_click">
                <img class="imv" src="../images/vedio.png">
            </button>
        </div>
    </div>
</template>
...
.output_box {
    ...
    top: 20px;
    left: 20px;
    border: 2px solid rgb(46, 218, 60);
}
...
.letter {
    ...
    height: 870px;
    border-radius: 25px;
    background-color: rgba(152, 175, 148, 0.7);
    font-family: "楷体";
    font-size: 30px;
    top: 20px;
    left: 20px;
